...
1. 在 GitHub Releases 中下载最新的 `marktab-2.0.4.zip`。
...
| `npm run package` | 先执行校验，再生成 `dist/marktab-2.0.4.zip`。 |
...
| `npm run bump -- 2.0.4` | 同步更新 `package.json`、`manifest.json`、README、提交说明和弹窗版本号。 |
